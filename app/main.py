...
def screen_text():
    ...
    if(package_type_select_data(value)):
        data = package_type_select_data(value)
    elif(goods_type_select_data(value)):
        data = goods_type_select_data(value)
    elif(sender_add_select_data(value)):
        data = sender_add_select_data(value)
    for i in range(len(data)):
        log_text.insert(tk.END, "{")
        log_text.insert(tk.END, data[i])
        log_text.insert(tk.END, "}")
        log_text.insert(tk.END, "\n")
